...
interface UpdateLichHocProps {
  isOpen: boolean;
  onRequestClose: () => void;
  id: number | null;
}

const UpdateLichHoc = ({ isOpen, onRequestClose, id }) => {
  ...
  const handleUpdateLichHoc = async () => {
    try {
      const body = {
        id: id,
        ...usersDetails,
  ...
  return (
    ...
    >
      ...
      <button className="save-btn" onClick={handleUpdateLichHoc}>
        Cập nhật
      </button>
      <ToastContainer />
    </Modal>
